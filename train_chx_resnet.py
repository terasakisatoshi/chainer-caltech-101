"""
taken from https://github.com/chainer/chainer/blob/master/chainerx_cc/examples/imagenet/train_imagenet.py
and applied some modification
e.g.
change default value of -E 10 -> 50
add tqdm at loop of iteration
"""
...
from chainerx_resnet import resnet50
